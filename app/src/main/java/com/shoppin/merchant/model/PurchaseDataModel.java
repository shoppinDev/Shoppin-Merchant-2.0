...
public class PurchaseDataModel implements Serializable{
    ...
    String orderId,customerId,amount,orderDate,orderStatus,customerName,customerEmail,customerPassword,customerMobile,isMobileVerify;

    public PurchaseDataModel(String orderId,String customerId,String amount,String orderDate,String orderStatus,String customerName,
