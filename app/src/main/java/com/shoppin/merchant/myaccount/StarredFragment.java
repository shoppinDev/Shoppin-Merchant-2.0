...
public class StarredFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listStarred = (ListView) view.findViewById(R.id.listStarred);
    ...
    class GetStarredTask extends AsyncTask<Void,Void,Void> {

        boolean success;
        String responseError;
        ProgressDialog dialog;
        public GetStarredTask(){
        }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if(success){
                if(dealArrayList.size() > 0){
                    adapter = new StarredListAdapter(getActivity(),android.R.layout.simple_list_item_multiple_choice,dealArrayList,getFragmentManager());
